  ...
  return (
    <>
      ...
      <main className="relative z-10"> {/* Ensure main content layers above background */}
        ...
        <div className="h-[10vh] flex items-center justify-center bg-blue-900"> {/* Ensure this has a background color */}
        ...
        {/* Content Section */}
        <section className="py-20 bg-blue-900"> {/* Ensure this has a background color */}
      ...
      <ul className="space-y-2">
        {items.map((item) => (
          <li key={item} className="flex items-center text-sm text-slate-700">
            <svg className="w-4 h-4 mr-2 text-blue-900" fill="currentColor" viewBox="0 0 20 20">
...
const Pill = () => <span className="w-2 h-2 bg-blue-900 rounded-full mr-3"></span>;
