  ...
  return (
    <>
      ...
      <main className="relative z-10"> {/* Ensure main content layers above background */}
        ...
        <div className="h-[10vh] flex items-center justify-center bg-blue-500"> {/* Ensure this has a background color */}
        ...
        {/* Content Section */}
        <section className="py-20 bg-blue-500"> {/* Ensure this has a background color */}
