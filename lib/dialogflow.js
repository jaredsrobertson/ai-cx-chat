...
class DialogflowService {
  constructor() {
    ...
    if (!credentialsEnvVar || !this.projectId) {
      logger.error("FATAL: GOOGLE_APPLICATION_CREDENTIALS and GOOGLE_CLOUD_PROJECT_ID must be set.");
      return;
    }
    ...
    try {
      ...
      try {
        ...
        logger.error("FATAL: GOOGLE_APPLICATION_CREDENTIALS is not a valid JSON string or file path.", fileError);
        return;
      }
    }
