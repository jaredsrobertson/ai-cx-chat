...
export const CloudIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M2.25 15a4.5 4.5 0 004.5 4.5h10.5a4.5 4.5 0 004.5-4.5c0-2.39-1.84-4.4-4.1-4.829a5.25 5.25 0 00-10.316-1.05c-.34.165-.668.358-.97.584A4.5 4.5 0 002.25 15z" />
  </svg>
);
...
export const BellIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24" {...props}>
    <path d="M11.25 4.5a7.5 7.5 0 011.232-4.125.75.75 0 011.058.42l.332.831a7.5 7.5 0 013.418 9.947.75.75 0 01-1.058.42l-.332-.831a6 6 0 00-2.734-7.957l-.332-.166A6 6 0 006 12.75v1.536c0 .64.314 1.234.84 1.603l1.241.828a7.5 7.5 0 01-8.32 9.043.75.75 0 01.378-1.422 6 6 0 006.657-7.234l-1.241-.828A2.25 2.25 0 014.5 14.286V12a7.5 7.5 0 017.5-7.5h-.75z" />
  </svg>
);

export const BellSlashIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24" {...props}>
    <path d="M11.25 4.5a7.5 7.5 0 011.232-4.125.75.75 0 011.058.42l.332.831a7.5 7.5 0 013.418 9.947.75.75 0 01-1.058.42l-.332-.831a6 6 0 00-2.734-7.957l-.332-.166A6 6 0 006 12.75v1.536c0 .64.314 1.234.84 1.603l1.241.828a7.5 7.5 0 01-8.32 9.043.75.75 0 01.378-1.422 6 6 0 006.657-7.234l-1.241-.828A2.25 2.25 0 014.5 14.286V12a7.5 7.5 0 017.5-7.5h-.75z" />
    <path fillRule="evenodd" d="M3.53 3.53a.75.75 0 011.06 0l18 18a.75.75 0 11-1.06 1.06l-18-18a.75.75 0 010-1.06z" clipRule="evenodd" />
  </svg>
);