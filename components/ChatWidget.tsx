    ...
    <>
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 z-40 bg-custom-blue text-white rounded-full p-5 shadow-lg hover:bg-opacity-90 transition-all hover:scale-110"
        >
                ...
                <div className="border-t border-gray-200 p-4 bg-white">
                  <div className="flex gap-2">
                    <input 
                      ...
                      disabled={isTyping} 
                      className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-custom-blue disabled:bg-gray-50 text-slate-800"
                    />
                    <button onClick={() => sendMessage(input)} disabled={isTyping || !input.trim()} className="px-4 py-2 bg-custom-blue text-white rounded-lg hover:bg-opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors">
