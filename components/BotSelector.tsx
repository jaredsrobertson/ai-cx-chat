    ...
    <div className="p-6">
      ...
      <div className="space-y-3">
        ...
        <div
          ...
          className="w-full p-4 border-2 border-gray-200 rounded-lg hover:border-[#3a8bc2] hover:bg-sky-50 transition-all group cursor-pointer"
        >
          <div className="flex items-start">
            <div className="flex-shrink-0 w-12 h-12 bg-sky-100 rounded-lg flex items-center justify-center group-hover:bg-sky-200 transition-colors">
              <svg className="w-6 h-6 text-[#3a8bc2]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
