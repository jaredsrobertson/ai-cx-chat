      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-brand-ui-01 dark:bg-dark-brand-ui-01 rounded-xl p-8 max-w-md w-full mx-4"
          >
            <div className="text-center mb-6">
              <div className="w-16 h-16 bg-brand-blue dark:bg-dark-brand-blue rounded-full flex items-center justify-center mx-auto mb-4">
                <HiOutlineLockClosed className="w-8 h-8 text-white dark:text-brand-text-primary" />
              </div>
              <h2 className="text-2xl font-bold text-brand-text-primary dark:text-dark-brand-text-primary">Login</h2>
            </div>
            <form onSubmit={handleSubmit} className="space-y-4" id="demo-login-form">
              ...
              <div className="bg-blue-50 dark:bg-dark-brand-ui-03 border border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-200 px-4 py-3 rounded-lg text-sm">
                ...
                >
                  {isLoading ? (
                    <div className="flex items-center justify-center">
                      <div className="w-5 h-5 border-2 border-white dark:border-brand-text-primary border-t-transparent rounded-full animate-spin mr-2"></div>
                      Signing In...
                    </div>
                  ) : (
                    'Sign In'
